...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 bg-white/50 backdrop-blur-md z-50 shadow-sm">
        ...
        {/* Desktop Navigation */}
        <nav className="hidden md:flex space-x-8 justify-center col-span-3">
          {navLinks.map((link) => {
        ...
        <button
          onClick={toggleMenu}
          className="md:hidden p-2 text-[#0B2239] hover:text-[#D7263D] transition-colors duration-200 col-span-6 col-start-7 flex justify-end"
